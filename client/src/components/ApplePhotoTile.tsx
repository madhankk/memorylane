...
export function ApplePhotoTile({ item, busy, onOpen, onOpenInPhotos, onCheckLocal }: {
  ...
  return <div className="overflow-hidden rounded-lg bg-surface ring-1 ring-border">
    {item.media ? <button type="button" onClick={onOpen} title={item.filename} className="aspect-square w-full bg-media">
