...
const assetSchema=z.object({uuid:z.string().min(1),original_filename:z.string().nullable(),original_path:z.string().nullable(),derivative_path:z.string().nullable(),original_available:z.boolean(),date:z.string().nullable(),title:z.string().nullable(),description:z.string().nullable(),keywords:z.array(z.string()),favorite:z.boolean(),hidden:z.boolean(),in_trash:z.boolean(),latitude:z.number().nullable(),longitude:z.number().nullable(),faces:z.array(faceSchema),exif:exifSchema.nullable().optional()});
