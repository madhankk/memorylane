...
// Intel Mac isn't a supported release target for now (see docs/deployment-playbook.md:
// LanceDB has no darwin-x64 build in the pinned version) - this script would
// otherwise quietly build a catalog/DMG nothing else expects to exist.
